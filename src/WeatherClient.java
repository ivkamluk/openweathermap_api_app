	...
	{	
		...
		else
		{
			for (int i=0; i<forecast_weather.size(); i++)
			{
				...
				System.out.print("Client: Temp > " + forecast_weather.get(i).getTemp());
				System.out.print(" Min temp > " + forecast_weather.get(i).getTempMin());
				System.out.print(" Max temp > " + forecast_weather.get(i).getTempMax());
